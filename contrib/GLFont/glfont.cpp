...
GLFontBase::GLFontBase() : ok(FALSE), scale(1.f), r(1.f), g(1.f), b(1.f)
{
}
...
//*********************************************************
void PixelPerfectGLFont::PrintText(string String, int x, int y, int z)
{
...
//*********************************************************
void GLFont::PrintText(string String, float x, float y, float z)
{
	//Return if we don't have a valid glFont
	if (!ok)
	{
